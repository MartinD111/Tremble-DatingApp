...
**Date:** 2026-07-20 · **Status:** **PHASE A+B MERGED (`43ec787`, PR #82) + SHIPPING IN BUILD 33** — server bearing live on prod; the combined two-phone device pass is the ONLY remaining item to close this feature · **Risk:** HIGH (core feature + sensors + BLE + prod CF, device-only) · **(cluster 4)**
