...
| 3.8   | Preostali drobci (batch)                                        | 🟨 IN PROGRESS — 3.8-1 ✅, 3.8-2 pending | 3.8-1 Info.plist Contacts reconcile → PR fix/info-plist-contacts-reconcile (2026-07-13); 3.8-2 flaky GymStep test pending |
